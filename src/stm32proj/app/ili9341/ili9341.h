...
#define ILI9341_RES_Pin       RES_TFT_Pin
#define ILI9341_RES_GPIO_Port RES_TFT_GPIO_Port
#define ILI9341_CS_Pin        CS1_TFT_Pin
#define ILI9341_CS_GPIO_Port  CS1_TFT_GPIO_Port
#define ILI9341_DC_Pin        DC_TFT_Pin
#define ILI9341_DC_GPIO_Port  DC_TFT_GPIO_Port
#define ILI9341_BLK_Pin        BLK_TFT_Pin
#define ILI9341_BLK_GPIO_Port  BLK_TFT_GPIO_Port

#define ILI9341_BLK_Clr() HAL_GPIO_WritePin(BLK_TFT_GPIO_Port, BLK_TFT_Pin, GPIO_PIN_RESET)
